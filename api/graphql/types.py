...
class ReviewSummaryType(graphene.ObjectType):
    ...
    pros = graphene.List(
        graphene.String, description="Top positive points from reviews"
    )
    cons = graphene.List(
        graphene.String, description="Top negative points from reviews"
    )
...
class SafetyAnalysisType(graphene.ObjectType):
    ...
    harmful_ingredients = graphene.List(
        GenericScalar, description="List of potentially harmful ingredients"
    )
    allergens = graphene.List(graphene.String, description="Common allergens present")
    certifications = graphene.List(
        graphene.String, description="Safety certifications or standards"
    )
    recalls = graphene.List(
        GenericScalar, description="Recent recalls or safety issues"
    )
