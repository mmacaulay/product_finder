...
SAMPLE_DE_PRODUCT_EMPTY_RESPONSE = {"entries": 0, "products": []}
...
def create_mock_de_product_response(
    description="Test Product", brand="Test Brand", upc="123456789012", image=None
):
    ...
    return {"entries": 1, "products": [product_data]}
