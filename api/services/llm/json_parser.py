...
def parse_llm_json(raw_response: str, strict: bool = False) -> tuple[Dict[str, Any], str]:
    """
...
def create_error_response(error_message: str, raw_response: Optional[str] = None) -> Dict[str, Any]:
    """
...
def validate_json_structure(data: Dict[str, Any], required_keys: Optional[list] = None) -> bool:
    """
